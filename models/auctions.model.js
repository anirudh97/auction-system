...
Auction.search = (email, searchData, result) => {
    ...
    if(!searchData.brand && searchData.category && searchData.color){
        sqlQuery = "WITH item_images AS( select item.item_id AS item_id, category, brand, type, color, model, imagePath, imageId FROM item join itemImages USING (item_id)) select auction_id, closing_date, auction.item_id, category, brand, type, color, model, imagePath, imageId, auction.email FROM auction JOIN item_images ON auction.item_id = item_images.item_id WHERE auction.winner = 'NA' AND auction.email != " + sql.escape(email) + " AND item_images.category = " + sql.escape(searchData.category) + " AND item_images.color = " + sql.escape(searchData.color);
    } else if(!searchData.category && searchData.brand && searchData.color){
        sqlQuery = "WITH item_images AS( select item.item_id AS item_id, category, brand, type, color, model, imagePath, imageId FROM item join itemImages USING (item_id)) select auction_id, closing_date, auction.item_id, category, brand, type, color, model, imagePath, imageId, auction.email FROM auction JOIN item_images ON auction.item_id = item_images.item_id WHERE auction.winner = 'NA' AND auction.email != " + sql.escape(email) + " AND item_images.brand = " + sql.escape(searchData.brand) + " AND item_images.color = " + sql.escape(searchData.color);
    } else if(searchData.category && searchData.brand && !searchData.color){
        sqlQuery = "WITH item_images AS( select item.item_id AS item_id, category, brand, type, color, model, imagePath, imageId FROM item join itemImages USING (item_id)) select auction_id, closing_date, auction.item_id, category, brand, type, color, model, imagePath, imageId, auction.email FROM auction JOIN item_images ON auction.item_id = item_images.item_id WHERE auction.winner = 'NA' AND auction.email != " + sql.escape(email) + " AND item_images.brand = " + sql.escape(searchData.brand) + " AND item_images.category = " + sql.escape(searchData.category);
    } else if(searchData.category && !searchData.brand && !searchData.color){
        sqlQuery = "WITH item_images AS( select item.item_id AS item_id, category, brand, type, color, model, imagePath, imageId FROM item join itemImages USING (item_id)) select auction_id, closing_date, auction.item_id, category, brand, type, color, model, imagePath, imageId, auction.email FROM auction JOIN item_images ON auction.item_id = item_images.item_id WHERE auction.winner = 'NA' AND auction.email != " + sql.escape(email) + " AND item_images.category = " + sql.escape(searchData.category);
    } else if(!searchData.category && searchData.brand && !searchData.color){
        sqlQuery = "WITH item_images AS( select item.item_id AS item_id, category, brand, type, color, model, imagePath, imageId FROM item join itemImages USING (item_id)) select auction_id, closing_date, auction.item_id, category, brand, type, color, model, imagePath, imageId, auction.email FROM auction JOIN item_images ON auction.item_id = item_images.item_id WHERE auction.winner = 'NA' AND auction.email != " + sql.escape(email) + " AND item_images.brand = " + sql.escape(searchData.brand);
    } else if(!searchData.category && !searchData.brand && searchData.color){
        sqlQuery = "WITH item_images AS( select item.item_id AS item_id, category, brand, type, color, model, imagePath, imageId FROM item join itemImages USING (item_id)) select auction_id, closing_date, auction.item_id, category, brand, type, color, model, imagePath, imageId, auction.email FROM auction JOIN item_images ON auction.item_id = item_images.item_id WHERE auction.winner = 'NA' AND auction.email != " + sql.escape(email)  + " AND item_images.color = " + sql.escape(searchData.color);
    } else if(!searchData.category && !searchData.brand && !searchData.color){
